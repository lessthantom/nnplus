		...
		<tr class="{cycle values=",alt"}">
			...
			<td colspan="7" class="left" id="guid{$result.guid}">
				<ul class="inline">
                    ...
                    <li style="vertical-align:text-bottom;">{if $weHasVortex}<div><a href="#" class="icon icon_nzbvortex" title="Send to my NZBVortex"><img src="{$smarty.const.WWW_TOP}/templates/baffi/images/icons/vortex/bigsmile.png"></a></div>{/if}</li>
				</ul>
