						...
						<tr id="guid{$mguid[$m@index]}" {if $m@index > 1}class="mlextra"{/if}>
							...
							<td class="icons">
								<ul class="inline">
                                    ...
                                    <li>{if $weHasVortex}<a href="#" class="icon icon_nzbvortex" title="Send to my NZBVortex"><img src="{$smarty.const.WWW_TOP}/templates/baffi/images/icons/vortex/bigsmile.png"></a>{/if}</li>
                                </ul>
