							...
							<ul class="inline">
								<li>
									<div class="icon icon_nzb">
										<a title="Download Nzb" href="{$smarty.const.WWW_TOP}/getnzb/{$result.guid}/{$result.searchname|escape:"url"}"><img src="{$smarty.const.WWW_TOP}/templates/default/images/icons/nzbup.png"></a>
									</div>
								</li>
								<li>
									<a class="icon icon_cart" href="#" title="Add to Cart">
										<img src="{$smarty.const.WWW_TOP}/templates/default/images/icons/cartup.png">
									</a>
								</li>
								{if $sabintegrated}
								<li>
									<a class="icon icon_sab" href="#" title="Send to Sab">
										<img class="icon icon_sab" alt="Send to my Sabnzbd" src="{$smarty.const.WWW_TOP}/templates/default/images/icons/sabup.png">
									</a>
								</li>
								{/if}
                                {if $weHasVortex}
                                    <li>
                                        <a class="icon icon_nzbvortex" href="#" title="Send to NZBVortex">
                                            <img class="icon icon_nzbvortex" alt="Send to my NZBVortex" src="{$smarty.const.WWW_TOP}/templates/default/images/icons/vortex/bigsmile.png">
                                        </a>
                                    </li>
                                {/if}
                                {if $isadmin}
