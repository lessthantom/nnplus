...
<form class="form-horizontal" action="{$SCRIPT_NAME}?action=submit" method="post">
	...
	<fieldset>
		...
		<div class="control-group">
			<label class="control-label" for="partsdeletechunks">Parts Delete In Chunks</label>
			<div class="controls">
				<input class="input input-xxlarge" class="tiny" id="partsdeletechunks" name="partsdeletechunks" type="text" value="{$fsite->partsdeletechunks}" />
				<span class="help-block">Default is 0 (off), which will remove parts in one go. If backfilling or importing and parts table is large, using chunks of 5000+ will speed up removal. Normal indexing is fastest with this setting at 0.</span>
			</div>
		</div>
        ...
        <div class="control-group">
            <label class="control-label" for="updateparsing">Perform Integrated Update Parsing</label>
            <div class="controls">
                ...
                <span class="help-block">Update Parsing is a mechanism to decode names using various techniques.</span>
            </div>
        </div>

        <div class="control-group">
            <label class="control-label" for="updatecleanup">Perform Integrated Update Cleanup</label>
            <div class="controls">
                ...
                <span class="help-block">Update Cleanup is a general mechanism for deleting and moving unwanted items into misc>other.</span>
            </div>
        </div>
...
<legend>Spotnab Settings</legend>
		...
		<div class="control-group">
			<label class="control-label" for="spotnabautoenable">Source Auto Enable</label>
			<div class="controls">
				...
				<span class="help-block">If enabled, newly discovered Spotnab sources will be enabled by default.</span>
			</div>
		</div>
		...
		<div class="control-group">
			<label class="control-label" for="spotnabsitepubkey">Public Key</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label" for="spotnabsiteprvkey">Public Key</label>
			<div class="controls">
